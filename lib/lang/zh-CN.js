export default {
  ...
  COMMON: {
    ...
    MORE: '更多',
    NO_MORE: '站内暂未收录，请前往公众号（水里月资源）获取。',
    LATEST_POSTS: '最新发布',
    TAGS: '标签',
    NO_TAG: 'NoTag',
    CATEGORY: '分类',
    ...
    COPYRIGHT_NOTICE: '本文采用 CC BY-NC-SA 4.0 许可协议，转载请注明出处。网盘链接为系统自动索引的互联网公开数据（基于正则表达式匹配技术），本站不存储、不控制、不编辑相关内容；用户点击即视为年满18周岁且自愿承担全部法律与技术风险；侵权投诉须提交版权证明、侵权链接及身份证明至shuiliyue@outlook.com，我们将第一时间作出处理。',
